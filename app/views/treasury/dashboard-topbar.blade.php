...
<div class="fixed">
    <nav class="top-bar" data-topbar>
      <!-- Title -->
      <ul class="title-area">
        <li class="name"><h1><a href="./dashboard" class="background-facebook">UCI</a></h1></li>
          ...
          <li class="has-form">
            <div class="row collapse">
              <div class="large-8 small-9 columns">
                <input type="text" placeholder="Busca alumnos" size="20">
              </div>
              <div class="large-4 small-3 columns">
                <a href="#" class="button expand background-green">Buscar</a>
              </div>
            </div>
          </li>
          <li class="divider"></li>
