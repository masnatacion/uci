...
Ext.define('Base.Number', 
{
    ...
    setValue: function(value){
		Base.Number.superclass.setValue.call(this, value != null ? value.toString().replace('.', this.decimalSeparator) : value);
    ...
    parseValue: function(value){
        ...
        return Base.Number.superclass.parseValue.call(this, this.removeFormat(value));
    },
    /**
    ...
    getErrors: function(value){
        return Base.Number.superclass.getErrors.call(this, this.removeFormat(value));
    },
    hasFormat: function(){
